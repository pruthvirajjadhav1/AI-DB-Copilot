package com.pruthvi.sqlAi.service.Impl;

import com.pruthvi.sqlAi.exception.EmptyQuestionException;
import com.pruthvi.sqlAi.model.QueryResult;
import com.pruthvi.sqlAi.service.SqlExecutorService;
import com.pruthvi.sqlAi.service.SqlQueryService;
import com.pruthvi.sqlAi.service.TextToSqlService;
...
public class SqlQueryServiceImpl implements SqlQueryService {
    ...
    public QueryResult processQuestion(String question) {
        ...
        return new QueryResult(
                sql,
                result.get(0),
                result.size() > 1 ? result.subList(1, result.size()) : Collections.emptyList(),
                executionTime
        );
    }
}
